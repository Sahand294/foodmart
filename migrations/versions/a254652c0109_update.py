...
Revision ID: a254652c0109
Revises: e0a4765fd7df
Create Date: 2025-08-16 09:49:32.776668
...
revision = 'a254652c0109'
down_revision = 'e0a4765fd7df'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('cart_products', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('cartid', sa.Integer(), nullable=False))
        ...
        batch_op.create_foreign_key(None, 'carts', ['cartid'], ['id'])
        batch_op.create_foreign_key(None, 'products', ['productid'], ['id'])
