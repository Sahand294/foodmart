...
Revision ID: 06dae4c67bc9
Revises: b23b65014456
Create Date: 2025-09-20 16:37:31.846726
...
revision = '06dae4c67bc9'
down_revision = 'b23b65014456'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('order_items', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_order', 'orders', ['order_id'], ['id'], ondelete='CASCADE')
        batch_op.create_foreign_key('fk_product', 'products', ['product_id'], ['id'], ondelete='RESTRICT')
        batch_op.create_foreign_key('fk_cart', 'carts', ['cart_id'], ['id'], ondelete='SET NULL')
